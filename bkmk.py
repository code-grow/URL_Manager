...
show_structure_button.grid(row=1, column=0, columnspan=5, pady=5)

tree_view_frame = tk.Frame(folder_management_frame)  # Set background color for tree view
tree_view_frame.grid(row=2, column=0, columnspan=5, pady=5, sticky="nsew")
...
folder_management_frame.grid_rowconfigure(2, weight=1)
